...
import { locales, LocaleText } from '@/lib/i18n/locales/cortisol';
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <HormoneHeader
          ...
          icon="/images/hormones/cortisol.svg"
          color="cortisol"
        />
        ...
        <DetailSection title={text.page.sections.definition.title}>
          <DetailGrid>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-md">
              <LocalizedSvgImage 
                basePath="/images/hormones/cortisol-pathway.svg" 
        ...
        >
          <DetailGrid cols={2}>
            <FactCard title={text.page.sections.release.factors.circadian.title} color="cortisol">
              <p>{text.page.sections.release.factors.circadian.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.release.factors.stress.title} color="cortisol">
              <p>{text.page.sections.release.factors.stress.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.release.factors.physical.title} color="cortisol">
              <p>{text.page.sections.release.factors.physical.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.release.factors.emotional.title} color="cortisol">
              <p>{text.page.sections.release.factors.emotional.content}</p>
            </FactCard>
          </DetailGrid>
          
          <HighlightBox title={text.page.sections.release.timing.title} color="cortisol" className="mt-8">
        ...
        <DetailSection title={text.page.sections.research.title}>
          <DetailGrid cols={2}>
            <FactCard title={text.page.sections.research.facts.rhythm.title} color="cortisol">
              <p>{text.page.sections.research.facts.rhythm.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.research.facts.stress.title} color="cortisol">
              <p>{text.page.sections.research.facts.stress.content}</p>
            </FactCard>
          </DetailGrid>
          
          <HighlightBox title={text.page.sections.research.healthyBalance.title} color="cortisol" className="mt-8">
