...
import { locales, LocaleText } from '@/lib/i18n/locales/oxytocin';

export function OxytocinPage() {
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <HormoneHeader
          ...
          icon="/images/hormones/oxytocin.svg"
          color="oxytocin"
        />
        ...
        <DetailSection title={text.page.sections.definition.title}>
          <DetailGrid>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-md">
              <LocalizedSvgImage 
                basePath="/images/hormones/oxytocin-pathway.svg" 
        ...
        >
          <DetailGrid cols={2}>
            <FactCard title={text.page.sections.release.factors.touch.title} color="oxytocin">
              <p>{text.page.sections.release.factors.touch.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.release.factors.social.title} color="oxytocin">
              <p>{text.page.sections.release.factors.social.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.release.factors.intimacy.title} color="oxytocin">
              <p>{text.page.sections.release.factors.intimacy.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.release.factors.nurturing.title} color="oxytocin">
              <p>{text.page.sections.release.factors.nurturing.content}</p>
            </FactCard>
          </DetailGrid>
          
          <HighlightBox title={text.page.sections.release.timing.title} color="oxytocin" className="mt-8">
            <p className="mb-3">{text.page.sections.release.timing.p1}</p>
            <p>{text.page.sections.release.timing.p2}</p>
          </HighlightBox>
        </DetailSection>
        ...
        <DetailSection title={text.page.sections.research.title}>
          <DetailGrid cols={2}>
            <FactCard title={text.page.sections.research.facts.social.title} color="oxytocin">
              <p>{text.page.sections.research.facts.social.content}</p>
            </FactCard>
            
            <FactCard title={text.page.sections.research.facts.stress.title} color="oxytocin">
              <p>{text.page.sections.research.facts.stress.content}</p>
            </FactCard>
          </DetailGrid>
          
          <HighlightBox title={text.page.sections.research.healthyBalance.title} color="oxytocin" className="mt-8">
